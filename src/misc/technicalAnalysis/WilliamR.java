...
public class WilliamR  extends TechnicalAnaysisBaseTrading{

	public WilliamR(List<Tick> bidTicks, List<Tick> askTicks, String name, double openPosition){
	...
	public List<Order> getOrders(){
	 ...
	 private static Strategy buildStrategy(TimeSeries bidSeries , TimeSeries askSeries) {
	        ...
	        WilliamsRIndicator askWilliamsRIndicator = new WilliamsRIndicator(askSeries, 14);
	        WilliamsRIndicator bidWilliamsRIndicator = new WilliamsRIndicator(bidSeries, 14);

	        // Entry rule
	        Rule entryRule = new OverIndicatorRule(askWilliamsRIndicator, Decimal.valueOf(-80));

	        // Exit rule
	        Rule exitRule = new UnderIndicatorRule(bidWilliamsRIndicator, Decimal.valueOf(-20));
