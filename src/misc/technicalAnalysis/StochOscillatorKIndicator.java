...
public class StochOscillatorKIndicator  extends TechnicalAnaysisBaseTrading{

	public StochOscillatorKIndicator(List<Tick> bidTicks, List<Tick> askTicks, String name, double openPosition){
	...
	public List<Order> getOrders(){
	 ...
	 private static Strategy buildStrategy(TimeSeries bidSeries , TimeSeries askSeries) {
	        ...
	        StochasticOscillatorKIndicator bidSof = new StochasticOscillatorKIndicator(bidSeries, 14);
	        StochasticOscillatorKIndicator askSof = new StochasticOscillatorKIndicator(askSeries, 14);
	        
	        SMAIndicator bidSma = new SMAIndicator(bidSof, 3);
	        SMAIndicator askSma = new SMAIndicator(askSof, 3);
	        
	        // Entry rule
	        Rule entryRule = new CrossedUpIndicatorRule(askSof, askSma);

	        // Exit rule
	        Rule exitRule = new CrossedDownIndicatorRule(bidSof, bidSma);
