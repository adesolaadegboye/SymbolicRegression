 ...
 */
public class myAutoWeka
extends AbstractClassifier implements AdditionalMeasureProducer {

    /** For serialization. */
    static final long serialVersionUID = 2907034203562786373L;
    
    List<java.lang.String> classifierList =  null;

    /** For logging Auto-WEKA's output. */
    final Logger log = LoggerFactory.getLogger(myAutoWeka.class);
    ...
    public static void main(String[] argv) {
        ...
        runClassifier(new myAutoWeka(), argv);
    }
    ...
    public void setClassifierList(List<String> list){
    	classifierList = new ArrayList<String>(list);
    }
    ...
    */
    public void buildClassifier(Instances is) throws Exception {
        ...
        for(int i = 0; i < parallelRuns; i++) {
            ...
            msExperimentPaths[i] = Files.createTempDirectory("autoweka"+bespokePath).toString() + File.separator;
            // Create in tmp. move to home directory
        ...
        //    if (classifierList  != null && classifierList.size()>0)
          //  	exp.allowedClassifiers =  new ArrayList<String>(classifierList);
        ...
        //Random rand = new Random(); // using seed = 1
     	//	int folds = 10;
     	//	evalAuto.crossValidateModel(autoWEKAClassifier, testInstancesAuto, folds, rand);
   ...
   public String getmsExperimentPaths(){
	   
	   return msExperimentPaths[0];
   }
   
   public String[] getmsExperimentPathsArray(){
	   
	   return msExperimentPaths;
   }
   
   public void setBespokePath(String  name){
	   bespokePath = name;
   }
   ...
   public double estimatedMetricValue(){
	   return estimatedMetricValue;
   }
   
   public double accuracy(){
	   return 1- estimatedMetricValue;
   }
   ...
   public String matrixString(){
	 String matrixString = "" ;
	   try {
		...
		System.out.println("myAutoWeka Matrix is empty");
	}
	   return matrixString;
   }
   ...
   public String detailString(){
	   String detail="";
	   try {
		   detail =   eval.toClassDetailsString();
	} catch (Exception e) {
		// TODO Auto-generated catch block
		System.out.println("myAutoWeka detail is empty");
	}
	   return detail;
   }
   ...
   public void setResamplingArgs(int sampleSize){
	   resamplingArgs = "numFolds="+ String.valueOf(sampleSize);
	   System.out.println("Resample Args is " + resamplingArgs );
   }
}
